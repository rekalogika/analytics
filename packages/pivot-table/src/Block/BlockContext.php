...
final readonly class BlockContext
{
    ...
    public function __construct(
        private TreeNodeDecoratorRepository $decoratorRepository,
    ...
    {
        return new self(
            decoratorRepository: $this->decoratorRepository,
    ...
    public function getDecoratorRepository(): TreeNodeDecoratorRepository
    {
        return $this->decoratorRepository;
    }
